// linux $ gcc tls-1.2-gpt4-o.c -I./mbedtls/include -I./mbedtls/library ./mbedtls/library/*.c
// win $ gcc tls-1.2-gpt4-o.c -I./mbedtls/include -I./mbedtls/library ./mbedtls/library/*.c -lws2_32 -lbcrypt
